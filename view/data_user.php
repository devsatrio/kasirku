      ...
      <div class="accordion" id="accordionExample">
        <div class="card">
          <div class="card-header" id="headingOne">
            <h2 class="mb-0">
            <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#listdata" aria-expanded="true" aria-controls="collapseOne">
            List Data
            </button>
            </h2>
          </div>
          <div id="listdata" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
            <div class="card-body">
        ...
        <div class="card">
          <div class="card-header" id="headingTwo">
            <h2 class="mb-0">
            <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#tambahdata" aria-expanded="false" aria-controls="collapseTwo">
            Tambah Data
            </button>
            </h2>
          </div>
...
<div class="modal fade bd-example-modal-lg" id="editModal<?php echo $row2['id'];?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
